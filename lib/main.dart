...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  double progress = 0;
  String url = 'https://ie-hr-plus.vercel.app';
  bool isLoading = true;
                  ...
                  onPermissionRequest: (controller, request) async {
                    ...
                    for (final resource in request.resources) {
                      if (resource == PermissionResourceType.CAMERA ||
                          resource == PermissionResourceType.DEVICE_RESOURCE_VIDEO_CAPTURE) {
                        if (ENABLE_CAMERA) {
                          if (isMobile) {
                            try {
                            ...
                            grantedResources.add(resource);
                                 ...
                                 resource == PermissionResourceType.DEVICE_RESOURCE_AUDIO_CAPTURE) {
