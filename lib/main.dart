...
class _WebViewScreenState extends State<WebViewScreen> with WidgetsBindingObserver {
  ...
  double progress = 0;
  String url = 'https://ie-meet.vercel.app';
  bool isLoading = true;
  ...
  static const bool ENABLE_MEDIA_AUTOPLAY = true;
  ...
  static const String SPLASH_TITLE = '';
  ...
  static const bool HAS_CUSTOM_SPLASH_IMAGE = true;
  ...
  static const bool HAS_CUSTOM_ERROR_IMAGE = true;
    ...
    try {
      ...
      if (canCheck || isSupported) {
        final didAuth = await auth.authenticate(
          localizedReason: 'Authenticate to access ieMeet',
